...
pub struct CliArgs {
    ...
    #[clap(short, long, env = "CIPHERA_SECRET_KEY_PATH")]
    pub secret_key_path: Option<PathBuf>,

    #[arg(long, env = "CIPHERA_MODE")]
    pub mode: Option<Mode>,

    /// RPC listen address
    // TODO: we should take this from figment
    #[arg(long, env = "CIPHERA_RPC_LADDR")]
    pub rpc_laddr: Option<String>,

    /// P2P listen address
    #[arg(long, env = "CIPHERA_P2P_LADDR")]
    ...
    /// Log format
    #[arg(value_enum, long, env = "CIPHERA_LOG_FORMAT", default_value = "PRETTY")]
    pub log_format: LogFormat,

    /// Data path
    #[arg(long, env = "CIPHERA_DB_PATH")]
    pub db_path: Option<PathBuf>,

    /// Smirk path
    #[arg(long, env = "CIPHERA_SMIRK_PATH")]
    pub smirk_path: Option<PathBuf>,

    /// Ethereum RPC URL
    #[arg(long, env = "CIPHERA_ETH_RPC_URL")]
    ...
    #[arg(long, env = "CIPHERA_ROLLUP_CONTRACT")]
    pub rollup_contract_addr: Option<String>,

    /// Sync chunk size
    #[arg(long, env = "CIPHERA_SYNC_CHUNK_SIZE")]
