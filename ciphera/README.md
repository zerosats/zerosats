...
![citrea](https://img.shields.io/badge/citrea-testnet%20%7C%20mainnet-7c3aed)
...
_Auto-generated by `noir/generate_fixtures.sh` — last refreshed 2026-05-26T16:24:48Z._

| Circuit | Role | Oracle | Verification key (hex) |
|---------|------|--------|------------------------|
| `signature` | Signature leaf | poseidon | `0x19a48c5e…7c7d179a` |
...
| `utxo` | UTXO leaf (recursion base) | poseidon | `0x01f38fbf…b800716a` |
| `agg_utxo` | 1-level aggregator | poseidon | `0x077def87…31aaa6aa` |
| `agg_agg` | Top-level aggregator (on-chain verifier) | keccak | `0x00e5fe01…7e0d8305` |
