...
_Auto-generated by `noir/generate_fixtures.sh` — last refreshed 2026-05-26T18:06:01Z._
...
| `signature32` | Signature leaf (32-byte message) | poseidon | 41 | 304 | 3,680 | `0x18eb83f8…85ca9a7f` |
| `signature32sha` | Signature leaf (sha256 message) | poseidon | 189 | 36,000 | 3,680 | `0x083633d6…6a89d41b` |
| `utxo` | UTXO leaf (recursion base) | poseidon | 40,371 | 140,337 | 3,680 | `0x01f38fbf…b800716a` |
| `agg_utxo` | 1-level aggregator | poseidon | 37,083 | 2,878,100 | 3,680 | `0x077def87…31aaa6aa` |
| `agg_agg` | Top-level aggregator (on-chain verifier) | keccak | 562 | 1,499,832 | 1,888 | `0x00e5fe01…7e0d8305` |
...
To refresh the table after touching any circuit, rerun `./noir/generate_fixtures.sh` from this directory, or `./ciphera/noir/generate_fixtures.sh` from the repo root — it recompiles every package, propagates VK hashes through the recursion stack, and rewrites the block above.
