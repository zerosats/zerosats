...
uint256 constant VK_HASH = 0x220dccea7032be2709ed3bfc823e3ba513139ea30766b3e8605c408051090d2f;
library HonkVerificationKey {
    function loadVerificationKey() internal pure returns (Honk.VerificationKey memory) {
        Honk.VerificationKey memory vk = Honk.VerificationKey({
            ...
            ql: Honk.G1Point({ 
               x: uint256(0x14fe57868537dd56790b2faa880cf817be23debdae125278fa1e0cbe17870c4f),
               y: uint256(0x2202f86835f2b9025787837230b091975d2dd021bf81cbb8e016986ea2546e35)
            }),
            qr: Honk.G1Point({ 
               x: uint256(0x13fff7284eb4bbe1299fa7662543f2e47bc1b926c5da16ac761c36a1d0a7d5aa),
               y: uint256(0x14bb8ccf3ada367534280dfe9ed2d6d1f5bec2398b8f64270ee7e8da44f4e37d)
            }),
            qo: Honk.G1Point({ 
               x: uint256(0x0cd2ed9435f9405af8e9befc24828e50fde4dfed7a364b49185c99db7dd467c6),
               y: uint256(0x146357d1de327d5628c1b8fb9755c7f2efffcb111bf03c4338a5c8446752a38a)
            }),
            q4: Honk.G1Point({ 
               x: uint256(0x164bcd6020ac177e1025409738c4facbc3a653ff73f0e06d2fe7eac70f32c889),
               y: uint256(0x17504963ed16d82930bdb3d01d86c0139869aae60a7b1d2ca8e4df67352a64a7)
            }),
            qm: Honk.G1Point({ 
               x: uint256(0x289631840f516aae5807c8f7e5d2b44958477e8117e94d3943178747324cae4b),
               y: uint256(0x189c1c2c19555b780f9817bf51ee8049241a61bf8c5afc6e77fba1f8c9ae968a)
            }),
            qc: Honk.G1Point({ 
               x: uint256(0x2f5bda6d522eadede57f62c8143b47ea12c4ec6dfbb40967868445f005b03356),
               y: uint256(0x254c1f8adec1cdf27e1ae24f43587dd2a96195fbf516b1932dd48ba680652d97)
            }),
            ...
            qArith: Honk.G1Point({ 
               x: uint256(0x2e7a25d24ef8ea74c401a875bbca4f8087623100336d600b4527bfa44c502b90),
               y: uint256(0x28d37b02c306e7d8e8066542c4981735555eafa23ca8e308e57c8c1f5721ca8c)
            }),
            qDeltaRange: Honk.G1Point({ 
               x: uint256(0x2e1cc04b60d932cbb5e74449786a8ad52d0f1879d6ddf3601f6f3f5ea4e4cd15),
               y: uint256(0x205da8b9afbed4d11729b7d9ef18598154b4ff1a73bd9be9d50ff11cbd10c85d)
            }),
            qElliptic: Honk.G1Point({ 
               x: uint256(0x190c665ca707c56b1c50127b0753f392fef2ffe6727ea211847e5c067401b3d2),
               y: uint256(0x05305f426bfa5707795388898b17029d2b56c04cfe339f18e3a9cb70d6350d0c)
            }),
            qMemory: Honk.G1Point({ 
               x: uint256(0x00cfec50ba0dde01a7cadfde66279a140a5b695bdda158b0112c1f24b711c4fe),
               y: uint256(0x2605a94557239e1a40915fd2070b27275a91268bf9841d853992c4c7c18acfce)
            }),
            qNnf: Honk.G1Point({ 
               x: uint256(0x1f9292629347a52c71c690ea4ed33dcf02dc2ced493fc96ae90919eff5b749f7),
               y: uint256(0x2b72c1387c72af6c9a848c4b3c7d95448104a879690a6ebb42e24c9d5404b3f7)
            }),
            qPoseidon2External: Honk.G1Point({ 
               x: uint256(0x208081958d44cab68f4bb26ef6fcac5ce15068ea0181128a43f738c7c6910400),
               y: uint256(0x08a11fe1b71d467b26e1c0d12695141041a2adc1150ce6b9ffcddfd78a4d1be6)
            }),
            qPoseidon2Internal: Honk.G1Point({ 
               x: uint256(0x1e13ba75c269bcbda8a5167209196a13cbc84da5e61121c934257219b080dd0f),
               y: uint256(0x14e4d9965ff0f586a342efe461d02ea216fe04ed08876880aab415cd920c986b)
            }),
            s1: Honk.G1Point({ 
               x: uint256(0x09562b22ecb60dc681ca92cdb41a643117b23fe3e1c9464b0c3c5c3fceff9526),
               y: uint256(0x2368fd1bc42658c1b57974b3441f7124c15901c1189828834987597d904e9bec)
            }),
            s2: Honk.G1Point({ 
               x: uint256(0x013b59213be04f61bc0f5c5591ab560a7ff5b60eaf55795810e1f8caf30c93b5),
               y: uint256(0x09011f532b6842e96b36a636be10a69ed73f24a18a480eafb38fc32db40ab2b0)
            }),
            s3: Honk.G1Point({ 
               x: uint256(0x14b33b2262d6905aa22ef92ccabb3a0ec5f14043330f880218f4f15d04c146e8),
               y: uint256(0x1b9527a573909d3f70bffa0fd09df21959e52849247f46921f00046662e87709)
            }),
            s4: Honk.G1Point({ 
               x: uint256(0x177866549c51d89ec8190954aacea256192aced9d663fa51215ca3d6f63f9b24),
               y: uint256(0x098ed283a9eda151607a32ddc1e0dbd306570306e82546d22bcd69730b7c23d7)
            }),
            t1: Honk.G1Point({ 
            ...
            id1: Honk.G1Point({ 
               x: uint256(0x1af2b946da88c8ee1640fe11772be1315221f2e13dcbc92cdbcce0ac8c2ec5a7),
               y: uint256(0x0385fb437b7b4376cfe73490b793c33f7b2728d617064a3aafb4c1e38a19113e)
            }),
            id2: Honk.G1Point({ 
               x: uint256(0x201de6558f57cb881e15d2d97fbc242c1b51362d9db91bedf33c731aa59200c7),
               y: uint256(0x0d6da83dc14b8e879398674016a550fa58b71314b899c1ac8ff46a3024936f13)
            }),
            id3: Honk.G1Point({ 
               x: uint256(0x042011d4ec21456c26600c98510ed704497b8fccdee75dace5db1d158b46b266),
               y: uint256(0x16567d28da745910c98df97fe5ac5ad136e9de01ca9311f98d4f76aa4b41fd2a)
            }),
            id4: Honk.G1Point({ 
               x: uint256(0x1d5233efdba236c325b054f47f34def9213c5957b04514cfcfff7bf97ee28c6f),
               y: uint256(0x07252997ea33d4ab2874c518f8ed3d6b7d5b216040fd038bc57fc9977a1fb2f1)
            }),
            ...
            lagrangeLast: Honk.G1Point({ 
               x: uint256(0x24976748ca4952d9a53f36e81c5152a4ec5c57e886756de23b2c3b1b1e1d8ffa),
               y: uint256(0x2255f4b06c01d566545020c7a99ca189cf73f2269c683349a371042ae389610a)
            })
        });
        return vk;
    }
