...
Install the specific `nargo` version, `1.0.0-beta.19`:
...
noirc version = 1.0.0-beta.19+6abff2f16e1c1314ba30708d1cf032a536de3d19
...
```bash
$ bb --version
v4.0.0-nightly.20260120
```

## Testing proof generation manually using CLI (non-recursive)

Assumes `bb` version: `v4.0.0-nightly.20260120`.
